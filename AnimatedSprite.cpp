...
AnimatedSpriteObject::AnimatedSpriteObject(int angle, float frameRate, int maxSprites, SDL_Rect sourceTransform, SDL_FRect destinationTransform)
	:SpriteObject(sourceTransform, destinationTransform, angle)
	, m_currentSpriteIndex{ 0 }
